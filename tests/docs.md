...
**Markers:**
- parametrize (zip_url, source_type[('github.com/bast0006.zip', <SourceTypeEnum.ZIP: 0>), ('gitlab.com/onerandomusername.zip', <SourceTypeEnum.REPO: 1>), (None, <SourceTypeEnum.LOCAL: 2>)])
### test_addonsource_init
Test the AddonSource init sets class vars appropiately.
